...
不绑定 TRAE 或任何单一客户端。不同 Agent 的发现目录和扩展字段可能不同；
...
Designed for Agent Skills-compatible agents, this project is not tied to TRAE
or any single client. The installer currently includes project-directory
